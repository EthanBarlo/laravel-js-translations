 ...
 *
 * Core translation logic shared between React and Alpine.js implementations.
 * These functions handle pluralization and placeholder replacements.
 */
...
export function parsePluralString(translationString: string): PluralSegment[] {
    ...
    // Split on pipes that are not escaped (simple approach)
 ...
 * Supports Laravel-style replacements like :item, :Item, :ITEM
 */
